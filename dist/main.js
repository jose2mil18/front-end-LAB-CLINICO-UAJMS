...
var map = {
	...
	"app/examenes/examenes.module": [
		...
		"default~app-examenes-examenes-module~app-pacientes-pacientes-module~app-reportes-reportes-module~app~3b8199d7",
		"default~app-examenes-examenes-module~app-pacientes-pacientes-module~app-resultados-resultados-module~f6620cd7",
		"common",
		"app-examenes-examenes-module"
	],
	...
	"app/resultados/resultados.module": [
		...
		"default~app-resultados-resultados-module~app-solicitudes-solicitudes-module",
		"common",
		"app-resultados-resultados-module"
	],
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authenticationService, pacienteService, solicitudesService, usuariosService, renderer, router) {
        var _this = this;
        ...
        this.links = [];
        this.enlaces = [];
        this.link_foto_perfil_usuario = "http://localhost:9898/api/file/";
        this.imageUrl = "";
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_angular_common__WEBPACK_IMPORTED_MODULE_9__["TitleCasePipe"]],
...
var PacientesService = /** @class */ (function () {
    ...
    PacientesService.prototype.filtro = function (procedencia, sexo, edad) {
        //'+global.server+'
        return this.http.get("" + ('' + _shared_variables_global__WEBPACK_IMPORTED_MODULE_2__["server"] + 'api/paciente?procedencia=') + procedencia + '&sexo=' + sexo + '&edad=' + edad, { headers: this.httpHeaders });
    };
...
var server = 'http://localhost:9898/';
...
var SolicitudesService = /** @class */ (function () {
    ...
    SolicitudesService.prototype.getFecha = function (solicitud) {
        return this.http.post("" + ('' + _shared_variables_global__WEBPACK_IMPORTED_MODULE_2__["server"] + 'api/pruebita'), solicitud, { headers: this.httpHeaders });
    };
