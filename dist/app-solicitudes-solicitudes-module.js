...
var FacturaComponent = /** @class */ (function () {
    function FacturaComponent(datePipe, solicitudesService) {
        var _this = this;
        ...
        var letras = this.u.numeroALetras(this.solicitud.costoTotal, {
            plural: "BOLIVIANOS",
            singular: "BOLIVIANO",
            centPlural: "CENTAVOS",
    ...
    FacturaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"], _solicitudes_service__WEBPACK_IMPORTED_MODULE_4__["SolicitudesService"]])
    ], FacturaComponent);
...
var ListarComponent = /** @class */ (function () {
    ...
    ListarComponent.prototype.captureScreen = function () {
        var examenes = "";
        var col = ["#", "Paciente", "Estado", "Fecha", "Analisis"];
        var rows = [];
        for (var i = 0; i < this.solicitudes.length; i++) {
            examenes = "";
            if (this.solicitudes[i].examenes_solicitados.length > 0) {
                for (var j = 0; j < this.solicitudes[i].examenes_solicitados.length; j++) {
                    console.log(i + " " + j);
                    console.log(this.solicitudes[i].examenes_solicitados.length);
                    examenes = examenes + this.solicitudes[i].examenes_solicitados[j].precio_examen.examen.nombre + "\n";
                }
            }
            var temp = [i + 1, this.solicitudes[i].nombres_paciente, this.solicitudes[i].estado, this.solicitudes[i].fecha, examenes];
            rows.push(temp);
        }
        var data = document.getElementById('contentToConvert');
        var pdf = new jspdf__WEBPACK_IMPORTED_MODULE_6___default.a('p', 'mm', 'letter'), margin = 10;
        pdf.page = 1;
    ...
    ListarComponent.prototype.b = function () {
        var doc = new jspdf__WEBPACK_IMPORTED_MODULE_6___default.a('p', 'pt', 'letter');
...
/***/ "./src/app/solicitudes/reporte/reporte.component.css":
/*!***********************************************************!*\
  !*** ./src/app/solicitudes/reporte/reporte.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/app/solicitudes/reporte/reporte.component.html":
/*!************************************************************!*\
  !*** ./src/app/solicitudes/reporte/reporte.component.html ***!
  \************************************************************/
/*! no static exports found */
...
var ReporteComponent = /** @class */ (function () {
    ...
    ReporteComponent.prototype.captureScreen = function () {
        var data = document.getElementById('contentToConvert');
        html2canvas__WEBPACK_IMPORTED_MODULE_2___default()(data).then(function (canvas) {
            ...
            var pdf = new jsPDF__WEBPACK_IMPORTED_MODULE_1__('p', 'mm', 'letter'), margin = 0.5;
            pdf.text(45, 45, '');
            var position = 0;
    ...
    ReporteComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./reporte.component.html */ "./src/app/solicitudes/reporte/reporte.component.html"),
            styles: [__webpack_require__(/*! ./reporte.component.css */ "./src/app/solicitudes/reporte/reporte.component.css")]
        }),
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _reporte_reporte_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./reporte/reporte.component */ "./src/app/solicitudes/reporte/reporte.component.ts");
/* harmony import */ var _modificar_modificar_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modificar/modificar.component */ "./src/app/solicitudes/modificar/modificar.component.ts");
...
/* harmony import */ var _factura_factura_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./factura/factura.component */ "./src/app/solicitudes/factura/factura.component.ts");
/* harmony import */ var angularx_qrcode__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! angularx-qrcode */ "./node_modules/angularx-qrcode/dist/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SolicitudesModule = /** @class */ (function () {
    ...
    SolicitudesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [primeng_calendar__WEBPACK_IMPORTED_MODULE_15__["CalendarModule"],
            ...
            declarations: [_registrar_registrar_component__WEBPACK_IMPORTED_MODULE_2__["RegistrarComponent"], _listar_listar_component__WEBPACK_IMPORTED_MODULE_3__["ListarComponent"], _reporte_reporte_component__WEBPACK_IMPORTED_MODULE_8__["ReporteComponent"], _modificar_modificar_component__WEBPACK_IMPORTED_MODULE_9__["ModificarComponent"], _factura_factura_component__WEBPACK_IMPORTED_MODULE_19__["FacturaComponent"]],
...
/* harmony import */ var _registrar_registrar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./registrar/registrar.component */ "./src/app/solicitudes/registrar/registrar.component.ts");
/* harmony import */ var _listar_listar_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./listar/listar.component */ "./src/app/solicitudes/listar/listar.component.ts");
/* harmony import */ var _reporte_reporte_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reporte/reporte.component */ "./src/app/solicitudes/reporte/reporte.component.ts");
/* harmony import */ var _modificar_modificar_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modificar/modificar.component */ "./src/app/solicitudes/modificar/modificar.component.ts");
/* harmony import */ var _factura_factura_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./factura/factura.component */ "./src/app/solicitudes/factura/factura.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'reporte',
        component: _reporte_reporte_component__WEBPACK_IMPORTED_MODULE_4__["ReporteComponent"]
    },
    {
        path: '',
        redirectTo: 'normal',
