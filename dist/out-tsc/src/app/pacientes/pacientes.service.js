...
var PacientesService = /** @class */ (function () {
    ...
    PacientesService.prototype.getAll = function () {
        return this.http.get("" + 'http://localhost:9898/api/pacientes', { headers: this.httpHeaders });
    };
    PacientesService.prototype.getByCedula = function (cedula) {
        return this.http.post("" + 'http://localhost:9898/api/buscarpaciente', { cedula: cedula }, { headers: this.httpHeaders });
    };
    PacientesService.prototype.update = function (paciente) {
        return this.http.post("" + 'http://localhost:9898/api/paciente', paciente, { headers: this.httpHeaders });
    };
    PacientesService.prototype.register = function (paciente) {
        return this.http.put("" + 'http://localhost:9898/api/paciente', paciente, { headers: this.httpHeaders });
    };
