...
var ExamenesSolicitadosComponent = /** @class */ (function () {
    function ExamenesSolicitadosComponent(reportesService, solicitudesService, datePipe, router) {
        ...
        this.reportesService.getReporteExamenesSolicitados(this.form.cedula, this.area.nombre, this.form.caracter_nombre_examen, this.form.fech, this.form.fecha_inicio, this.form.fecha_fin, this.form.estado_solicitud).subscribe(function (data) {
    ...
    ExamenesSolicitadosComponent.prototype.filtro_completo = function (formu) {
        ...
        if (formu.valid && ($('#fecha_inicio').val() <= $('#fecha_fin').val())) {
            ...
            this.reportesService.getReporteExamenesSolicitados(this.form.cedula, this.form.nombre_area, this.form.caracter_nombre_examen, this.form.fech, this.form.fecha_inicio, this.form.fecha_fin, this.form.estado_solicitud).subscribe(function (data) {
                _this.reporte_examenes_solicitados = data;
                console.log(data);
            });
        }
    };
    ExamenesSolicitadosComponent.prototype.onSort = function () {
    ...
    ExamenesSolicitadosComponent.prototype.klp = function () {
        this.router.navigate(['/reportes/examenes-solicitados']);
    };
    ExamenesSolicitadosComponent.prototype.updateRowGroupMetaData = function () {
        this.rowGroupMetadata = {};
        if (this.examenes_solicitados) {
            for (var i = 0; i < this.examenes_solicitados.length; i++) {
                var rowData = this.examenes_solicitados[i];
                var brand = rowData.precio_examen.examen.nombre;
                if (i == 0) {
                    this.rowGroupMetadata[brand] = { index: 0, size: 1 };
                }
                else {
                    var previousRowData = this.examenes_solicitados[i - 1];
                    var previousRowGroup = previousRowData.precio_examen.examen.nombre;
...
var ReportesService = /** @class */ (function () {
    ...
    ReportesService.prototype.getReporteExamenesSolicitados = function (cedula, nombre_area, caracter_nombre_examen, fecha_solicitud, fecha_inicio, fecha_fin, estado_solicitud) {
        return this.http.get("" + ('' + _shared_variables_global__WEBPACK_IMPORTED_MODULE_2__["server"] + 'api/reporte-examenes-solicitados?cedula=') + cedula + '&nombre_area=' + nombre_area + '&caracter_nombre_examen=' + caracter_nombre_examen + '&fecha_solicitud=' + fecha_solicitud + '&fecha_inicio=' + fecha_inicio + '&fecha_fin=' + fecha_fin + '&estado_solicitud=' + estado_solicitud, { headers: this.httpHeaders });
    };
