...
var ListarSolicitadosComponent = /** @class */ (function () {
    ...
    ListarSolicitadosComponent.prototype.klp = function () {
        console.log("hola");
...
var ModificarComponent = /** @class */ (function () {
    function ModificarComponent(titleCasePipe, datePipe, fb, examenesService, router) {
        var _this = this;
...
var RegistrarComponent = /** @class */ (function () {
    ...
    RegistrarComponent.prototype.onSubmit = function (form) {
        ...
        console.log(this.examen);
        if (form.valid) {
            this.examenesService.registrar(this.examen).subscribe(function (data) {
                console.log(data);
                alert("examen " + data.nombre + " guardado");
                _this.router.navigate(['/examenes/listar']);
            });
