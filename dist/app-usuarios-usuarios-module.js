...
var RegistrarComponent = /** @class */ (function () {
    ...
    RegistrarComponent.prototype.rolseleccionar = function (d) {
        console.log($('#rol').val());
    };
